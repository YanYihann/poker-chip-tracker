...
export function CentralPot({ amountLabel, streetLabel, statusLabel, street, handKey }: CentralPotProps) {
  ...
  return (
    <section className="pointer-events-none absolute left-1/2 top-1/2 z-20 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center rounded-3xl border border-stitch-primary/10 bg-stitch-surfaceContainerHigh/70 px-5 py-4 text-center shadow-[var(--stitch-shadow-float)] backdrop-blur">
